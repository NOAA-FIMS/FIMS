...
namespace {
// Information_SetupPriors
// IO correctness
// Test random effects using variable map and double values
TEST(Information_SetupPriors, HandlesCorrectInput) {
  ...
  std::shared_ptr<fims::popdy::LogisticSelectivity<double> > selectivity1 =
  ...
  std::shared_ptr<fims::popdy::LogisticSelectivity<double> > selectivity2 =
      std::make_shared<fims::popdy::LogisticSelectivity<double> >();
  ...
  std::shared_ptr<fims::distributions::NormalLPDF<double> >
      normal_inflection_point =
          std::make_shared<fims::distributions::NormalLPDF<double> >();
  std::shared_ptr<fims::distributions::LogNormalLPDF<double> > lognormal_slope =
      std::make_shared<fims::distributions::LogNormalLPDF<double> >();
