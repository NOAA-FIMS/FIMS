...
TEST_F(CAAEvaluateTestFixture, CalculateRecruitment_works) {
  ...
  EXPECT_NEAR(dq["numbers_at_age"][r_i_age_year],
              expect_recruitment[r_i_age_year], 1e-9);
