...
TEST(Information_SetupRandomEffects, HandlesCorrectInput) {
  ...
  std::shared_ptr<fims::popdy::SRBevertonHolt<double> > recruitment =
  ...
  std::shared_ptr<fims::distributions::NormalLPDF<double> > normal =
