...
namespace
{
    ...
    TEST_F(SPEvaluateTestFixture, CalculateDepletion_works)
    {
        ...
        depletion_expected[year-1] = fims_math::inv_logit(0.0, 1.0, 
            surplus_production_model->populations[0]->depletion->logit_depletion[year-2]);
        ...
        EXPECT_EQ(fims_math::inv_logit(0.0,1.0,
