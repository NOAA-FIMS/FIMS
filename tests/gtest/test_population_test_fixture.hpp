...
namespace
{
    ...
    protected:
        ...
        void InitializeCAA()
        {
            ...
            {
                this->catch_at_age_model->InitializePopulationDerivedQuantities(this->catch_at_age_model->populations[p]->GetId());
                 ...
                 ++fit)
            {
                ...
                this->catch_at_age_model->InitializeFleetDerivedQuantities(fleet->GetId());
                std::map<std::string, fims::Vector<double>> &derived_quantities =
