...
TEST_F(CAAPrepareTestFixture,
  ...
  for (int year = 0; year < population->n_years; year++) {
    for (int age = 0; age < population->n_ages; age++) {
      ...
      mortality_Z[i_age_year] = fims::math::exp(population->log_M[i_age_year]) +
    ...
    for (int age = 0; age < population->n_ages; age++) {
      ...
      if (year == 0 && age > 0) {
        ...
        test_unfished_numbers_at_age[i_age_year] =
            ...
            fims::math::exp(
                -fims::math::exp(population->log_M[i_age_year - 1]));
      }
      ...
      if (year > 0 && age > 0) {
        ...
        test_unfished_numbers_at_age[i_age_year] =
            ...
            fims::math::exp(
                -fims::math::exp(population->log_M[i_agem1_yearm1]));
      }
      ...
      if (age == (population->n_ages - 1)) {
        ...
        test_unfished_numbers_at_age[i_age_year] +=
            ...
            fims::math::exp(
                -fims::math::exp(population->log_M[i_agem1_yearm1 + 1]));
      }
