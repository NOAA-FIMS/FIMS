...
#include "../../tests/gtest/test_caa_population_test_fixture.hpp" 

namespace
{
    TEST_F(CAAPopulationEvaluateTestFixture, CalculateB_and_SB_works)
    {
    ...
    TEST_F(CAAPopulationEvaluateTestFixture, CalculateSpawningBiomass_ExtraYear_works)
    {
        uint32_t pop_id = population->GetId();
