...
validate_fims <- function(
  ...
  if (use_fimsfit == TRUE){
    ...
    sdr_naa <- sdr_report[which(sdr_report$name == "NAA"), c("est", "se")]
    ...
    # Biomass
    sdr_biomass <- sdr_report[which(sdr_report$name == "Biomass"), c("est", "se")]
    ...
    # Spawning biomass
    sdr_sb <- sdr_report[which(sdr_report$name == "SSB"), c("est", "se")]
    ...
    sdr_rdev <- sdr_report[which(sdr_report$name == "LogRecDev"), c("est", "se")]
    ...
    sdr_F <- sdr_report[which(sdr_report$name == "FMort"), c("est", "se")]
    ...
    fims_index <- sdr_report[which(sdr_report$name == "ExpectedIndex"), c("est", "se")]
    ...
    sdr_cnaa <- sdr_report[which(sdr_report$name == "CNAA"), c("est", "se")]
