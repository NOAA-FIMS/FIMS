...
test_that("nll test of fims", {
  ...
  for (y in 1:om_input_list[[iter_id]][["nyr"]]) {
    ...
    lengthcomp_nll_fleet <- lengthcomp_nll_fleet -
      dmultinom(
        fishing_lengthcomp_observed[y, ] * em_input_list[[iter_id]][["n.L.lengthcomp"]][["fleet1"]], size = NULL,
        fishing_lengthcomp_expected[y, ], TRUE
      )
  
    lengthcomp_nll_survey <- lengthcomp_nll_survey -
      dmultinom(
        survey_lengthcomp_observed[y, ] * em_input_list[[iter_id]][["n.survey.lengthcomp"]][["survey1"]], size = NULL,
