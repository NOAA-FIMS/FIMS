...
test_that("posterior equals prior with no data", {
  ...
  slope_prior$uncertainty$resize(1)
  slope_prior$uncertainty[1]$value <- slope_var
  slope_prior$uncertainty$set_transformation("identity")
  slope_prior$uncertainty$set_uncertainty_name("var")
  ...
  inflection_point_prior$uncertainty$resize(1)
  inflection_point_prior$uncertainty[1]$value <- inflection_point_var
  inflection_point_prior$uncertainty$set_transformation("identity")
  inflection_point_prior$uncertainty$set_uncertainty_name("var")
