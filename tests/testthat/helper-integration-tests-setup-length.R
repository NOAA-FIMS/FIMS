...
setup_and_run_FIMS <- function(iter_id,
  ...
  fishing_fleet_length_comp <- new(LengthComp, om_input$nyr, om_input$nlengths)
  fishing_fleet_length_comp$length_comp_data <- c(t(em_input$L.length.obs$fleet1)) * em_input$n.L$fleet1
