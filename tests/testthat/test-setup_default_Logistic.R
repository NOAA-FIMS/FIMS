...
# setup_default_Logistic ----
## Setup ----
# No setup required.

## IO correctness ----
test_that("`setup_default_Logistic()` works with correct inputs", {
  result <- FIMS:::setup_default_Logistic()

  #' @description Test that output has the expected labels and values.
  expect_s3_class(result, "tbl_df")
  expect_equal(result[["label"]], c("inflection_point", "slope"))
  expect_equal(result[["value"]], c(2, 1))
