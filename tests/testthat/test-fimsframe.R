...
test_that("`fims_frame()` works with the correct inputs", {
  ...
  #' @description Test that `plot` is not exported from the `FIMS` namespace to avoid masking `graphics::plot` on package attach.
  expect_false("plot" %in% getNamespaceExports("FIMS"))
