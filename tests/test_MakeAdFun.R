...
ewaa_growth$weights <- om_input$W.kg
...
survey_fleet_selectivity$slope$value <- 2
...
opt <- with(obj, nlminb(fims$get_fixed(), fn, gr))
# message("success!")
#report <- obj$report()
