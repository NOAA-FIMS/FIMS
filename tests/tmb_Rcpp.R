...
skip_optimization <- identical(Sys.getenv("FIMS_TMB_RCPP_SKIP_OPTIMIZATION", "1"), "1")
...
cat("Rcpp objective at start:", objective_at_start, "\n")
cat("Rcpp n_fixed:", length(parameters[["p"]]), "n_random:", length(parameters[["re"]]), "\n")
