...
# Integration test: model comparison project case 0 operating model 1

## Test ID

[integration_test.mcp_c0_om1_works](https://github.com/NOAA-FIMS/FIMS/blob/debug-integration-test/tests/gtest/integration_test_population.cpp)
...
Currently, FIMS only runs one deterministic integration test case 0 (C0). Here the case 0 sets standard deviations of recruitment in log space to 0.0. All other operating model settings are the same as case 0 in [Li et al. (2021)](https://spo.nmfs.noaa.gov/content/fishery-bulletin/comparison-4-primary-age-structured-stock-assessment-models-used-united). 
...
```
  ...
  - FIMS modules under FIMS/inst/include have been 100% tested by either C++ unit test or itegration test.
...
- Current test data files are stored in FIMS. An R data package may need to be developed to conduct integration tests. 
  ...
  - The test data can be better documented following R data pacakge documentation guides. 
