...
#
# Match tmb_Rcpp.R: likelihood components and links are established before the
# final model-assembly call.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Final model assembly -- lifecycle-equivalent target for CreateTMBModel().
# -----------------------------------------------------------------------------
