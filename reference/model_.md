...
model. A FIMS model accepts vectors of data and thus each of the
`model_*()` functions, where the star can be replaced with the data type
separated by underscores, e.g., weight_at_age. These accessor functions
are the preferred way to pass data to a FIMS module because the data
