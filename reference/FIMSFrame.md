...
data and all landings data next to landings data. Thus, `age_comp` data
...
`age_comp` information for fleet1 will come before survey1. Next, all
data within type and fleet are arranged by timing, e.g., by year. That
is the end of the sorting for time series data like landings and
indices. The biological data are further sorted by bin. Thus, `age_comp`
