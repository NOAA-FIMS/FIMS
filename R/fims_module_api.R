...
#' Set age bins for age-specific selectivity
#' @param selectivity An age-specific selectivity [fims_module].
#' @param ages Numeric vector of age bins.
#' @return The module, invisibly.
#' @export
set_selectivity_ages <- function(selectivity, ages) {
  check_module(selectivity, "Selectivity", "selectivity")
  set_selectivity_ages_(selectivity[["pointer"]], as.numeric(ages))
