...
methods::setMethod(
  ...
  function(x) {
    ...
    estimates <- dplyr::left_join(
      ...
      dplyr::relocate(dplyr::all_of("uncertainty"), .after = dplyr::all_of("estimation_status"))
  }
)
...
fit_fims <- function(input,
  ...
  # If the estimation_status of all parameters is assumed_known, FIMS will abort if
