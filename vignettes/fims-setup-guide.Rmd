...
Please follow the section below that matches how you plan to set up FIMS, i.e., ☁️[Google Cloud Workstations](#google-cloud-workstations) for managed cloud IDEs (internal NOAA), 🌐[GitHub Codespaces](#github-codespaces) for browser-based containerized environments, 🐧[Windows Subsystem for Linux 2 (WSL2)](#wsl2) for a containerized Linux environment running on Windows hardware, and 🧑‍💻[Local](#local) installation for direct deployment on your machine's primary operating system.
