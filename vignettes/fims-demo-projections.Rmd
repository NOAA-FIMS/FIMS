...
The native initializer does not yet expose the prior and projection links needed
to fit this example. The setup below is retained as the intended user workflow,
but model fitting and plotting are not evaluated until those native entry points
are available.
...
```{r fit-plot-projections, eval=FALSE}
#| fig.alt: >
