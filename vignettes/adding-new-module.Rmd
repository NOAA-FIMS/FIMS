...
- **Namespaces**: nested under `fims`, with snake_case components (e.g.,
  `fims::popdy`, `fims::info`)
...
class LogisticSelectivityInterface : public SelectivityInterfaceBase {
 public:
  ...
  virtual double evaluate(double x) {
    fims::popdy::LogisticSelectivity<double> logistic_sel;
...
- Use `fims::popdy` for population-dynamics modules.
- Use `fims::info` for shared information and TMB integration.
- Use `fims::math` for mathematical helper functions.
