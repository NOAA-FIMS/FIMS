...
### 2.1 Understand the variable objects first
...
```cpp
fims::Vector<Type> my_variable;
Type value = my_variable[0];
Type value_at_time = my_variable.get_force_scalar(time_index);
```
