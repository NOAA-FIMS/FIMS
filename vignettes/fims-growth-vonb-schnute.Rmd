...
This vignette uses the interpolation-based variability pathway, which supplies standard deviation at the two reference ages through `length_at_age_sd_at_reference_ages`.
