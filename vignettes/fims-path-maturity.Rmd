...
Shown above, the maturity module has a get_id method (i.e. function) that returns a unique ID for this specific module.
...
Each field (i.e. parameter) from maturity will therefore inherit the five fields defined in the Parameter class: **value**, **min**, **max**, **is_random_effect**, **estimated**. 
