...
```{r, eval = FALSE}
fims$population <- new(fims$Population)
#set up population specific parameters
#...
#set maturity for the population
fims$population$SetMaturity(fims$maturity$get_id())
```
