...
We also need to set up recruitment log_devs. FIMS recruitment modules have a boolean, *estimate_log_devs* to specify whether or not log_devs are estimated; and a vector, *log_devs* to set the deviation values. The *log_devs* vector takes values greater than 0 as these will be logged in the likelihood.
