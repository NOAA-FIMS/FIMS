...
The next step is to link this distribution to the expected value of the fleet, expected_index, using the 
...
```{r fleet-expected}
fishing_fleet_index_distribution$set_distribution_links("data", fishing_fleet$expected_index$get_id())
...
fishing_fleet_agecomp_distribution$set_distribution_links("data", fishing_fleet$catch_numbers_at_age$get_id())
```
### The Survey Module
...
survey_fleet_index_distribution$set_distribution_links("data", survey_fleet$expected_index$get_id())
...
survey_fleet_agecomp_distribution$set_distribution_links("data", survey_fleet$catch_numbers_at_age$get_id())
```
...
recruitment_distribution$log_sd$estimated_m = FALSE
```
...
recruitment_distribution$set_density_links("random_effects", recruitment$log_devs$get_id())
```
#### Growth
