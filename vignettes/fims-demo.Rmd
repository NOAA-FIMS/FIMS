...
# Update default "survey1" selectivity from "Logistic" to "AgeSpecificSelectivity"
# This calls the dependent function setup_default_AgeSpecificSelectivity()
# This function is also used by setup_default_Selectivity() and setup_default_parameters()
...
# Values for first two ages are set to generic initial values and estimated using "fixed_effects"
# All other values are fixed to true approximate values used in generating demo data
...
age_specific_selectivity_fit <- parameters_age_specific_selectivity |>
  initialize_fims(data = data_4_model) |>
  fit_fims(optimize = TRUE)
get_estimates(age_specific_selectivity_fit) |> dplyr::filter(module_name == "Selectivity", module_type == "AgeSpecific")
