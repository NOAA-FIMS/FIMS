...
The results can be plotted with either base R, {ggplot2}, or {stockplotr}. Where, we reccommend using {stockplotr} where possible.
...
stockplotr::plot_biomass(
  list("age" = get_estimates(age_only_fit) |>
      dplyr::mutate(
        sex = NA,
        season = 1,
        era = "time",
