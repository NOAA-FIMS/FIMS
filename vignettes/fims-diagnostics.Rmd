...
base_model <- parameters |>
  ...
  fit_fims(optimize = TRUE, backend = "quadra")
...
The native result table does not yet provide the complete year and peel metadata
required by the following retrospective summaries, so these examples are not
evaluated during the vignette build.

```{r, mohns_rho, eval=FALSE}
...
```{r, plot-spawning-biomass, message = FALSE, warning = FALSE, eval=FALSE}
#| fig.alt: >
...
```{r retrospective-table, eval=FALSE}
retro_fit[["estimates"]] |>
