...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7fcb511d1530>, x, y, z)
...
```
    ...
    ##   mean(x) 421.898 430.143 437.3519 436.0790 442.7965   526.643   100
    ##  meanC(x) 372.014 372.635 493.1765 374.7895 383.7215 11869.515   100
