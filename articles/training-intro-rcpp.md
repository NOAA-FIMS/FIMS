...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f5a44b49410>, x, y, z)
...
```
    ...
    ##   mean(x) 422.098 431.841 437.8122 436.214 442.0055   523.277   100
    ##  meanC(x) 371.874 372.415 479.5506 372.971 382.5240 10701.069   100
