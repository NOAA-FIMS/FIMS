...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f2c6f7af3f0>, x, y, z)
...
```
    ...
    ##   mean(x) 418.741 431.179 437.7411 435.507 444.6145   513.688   100
    ##  meanC(x)  94.096  94.361 207.0111  94.581  95.9190 11060.896   100
