...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f99e47a53f0>, x, y, z)
...
```
    ...
    ##   mean(x) 423.880 433.668 439.4546 437.2250 445.5800   512.686   100
    ##  meanC(x)  94.145  94.326 196.4914  94.6215  95.2975 10158.862   100
