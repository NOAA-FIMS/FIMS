...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f1953dd0530>, x, y, z)
...
```
    ...
    ##   mean(x) 469.746 492.124 496.1468 493.4365 502.785   583.014   100
    ##  meanC(x) 419.261 419.837 540.2661 421.3195 431.004 11880.622   100
