...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7fb7dcff53f0>, x, y, z)
...
```
    ...
    ##   mean(x) 416.637 433.038 438.7960 437.2805 444.765   507.817   100
    ##  meanC(x)  94.146  94.356 199.9028  94.5870  94.937 10468.106   100
