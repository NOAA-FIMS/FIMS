...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7ff80f5d3530>, x, y, z)
...
```
    ...
    ##   mean(x) 420.995 430.002 435.2827 434.2940 438.779   513.328   100
    ##  meanC(x) 371.703 372.119 479.5185 372.7755 381.521 10733.889   100
