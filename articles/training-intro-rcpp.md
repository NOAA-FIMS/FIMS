...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7fd905381410>, x, y, z)
...
```
    ...
    ##   mean(x) 421.366 430.4985 437.2388 435.999 442.431   523.427   100
    ##  meanC(x) 371.904 372.4450 476.6854 372.861 382.324 10393.309   100
