...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f6d2d063530>, x, y, z)
...
```
    ...
    ##   mean(x) 422.869 431.775 436.9891 435.948 442.7765   503.479   100
    ##  meanC(x) 371.924 372.415 475.2762 375.601 382.8335 10104.053   100
