...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f28b298f3f0>, x, y, z)
...
```
    ...
    ##   mean(x) 472.080 491.268 495.3740 493.3805 501.929   572.668   100
    ##  meanC(x) 105.716 105.922 209.7678 106.5580 106.989 10348.876   100
