...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f0dd39733f0>, x, y, z)
...
```
    ...
    ##   mean(x) 468.986 492.095 496.8855 494.058 503.0015  567.722   100
    ##  meanC(x) 105.567 105.888 206.5609 106.478 107.6945 9977.621   100
