...
```
    ...
    ## ℹ Total run time was 1.30114 minutes
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.0
    ## ℹ Total run time was 1.28298 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.0
    ## ℹ Total run time was 1.3098 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.0 ℹ Total run time was 10.82142 seconds ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.0 ℹ Total run time was 1.05985 minutes ℹ Number of
    ## parameters: fixed_effects=77, random_effects=0, and total=77 ℹ Maximum
