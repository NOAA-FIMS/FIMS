...
```
    ...
    ## ℹ Total run time was 1.29481 minutes
...
```
    ...
    ##                  timestamp   level
    ## 1 Wed Jul 29 18:38:55 2026 warning
    ##                                                                   message id
...
```
    ...
    ##                  timestamp   level
    ## 1 Wed Jul 29 18:38:55 2026 warning
    ## 2 Wed Jul 29 18:38:55 2026 warning
    ##                                                                   message id
    ## 1 The log_f_multiplier vector is not of size n_years. Filling with zeros.  0
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.4.9000
    ## ℹ Total run time was 1.262 minutes
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.4.9000
    ## ℹ Total run time was 1.29871 minutes
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.4.9000 ℹ Total run time was 11.68086 seconds ℹ Number
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.4.9000 ℹ Total run time was 1.18853 minutes ℹ Number
    ## of parameters: fixed_effects=49, random_effects=29, and total=78 ℹ Maximum
