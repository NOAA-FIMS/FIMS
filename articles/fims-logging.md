...
```
    ...
    ## internal C++ function <0x55f6c83b40f0>
...
```
    ...
    ## ℹ Maximum gradient went from 0.01112 to 0.00083 after 3 steps.
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0
    ## ℹ Total run time was 6.18442 seconds
    ## ℹ Number of parameters: fixed_effects=48, random_effects=29, and total=77
    ## ℹ Maximum gradient= 0.00083
    ## ℹ Negative log likelihood (NLL):
    ## • Marginal NLL= 3309.37124
    ## • Total NLL= 3240.12853
    ## ℹ Terminal SB= 1808.20516
