...
```
    ...
    ## internal C++ function <0x555cacbd4a20>
    ##     docstring : See https://noaa-fims.github.io/doxygen/rcpp__interface_8hpp.html.
...
```
    ...
    ## ℹ Total run time was 1.30275 minutes
