#ifndef FIMS_DISTRIBUTIONS_FUNCTORS_DENSITY_COMPONENTS_BASE_H
#define FIMS_DISTRIBUTIONS_FUNCTORS_DENSITY_COMPONENTS_BASE_H
...
// #include "../../interface/interface.hpp"
#include "F_interface_interface_tmb.h"
// #include "../../common/fims_vector.hpp"
