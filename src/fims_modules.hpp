...
RCPP_MODULE(fims)
{
        ...
        Rcpp::class_<FleetInterface>("Fleet")
            ...
            .method("GetSelectivityLengthID", &FleetInterface::GetSelectivityLengthID)
            .method("show", &FleetInterface::show);
        ...
        Rcpp::class_<PopulationInterface>("Population")
            ...
            .method("evaluate", &PopulationInterface::evaluate,
                    "evaluate the population function")
            .method("show", &PopulationInterface::show,
                    "The printing methods for a PopulationInterface object.");
