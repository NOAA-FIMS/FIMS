...
namespace
{
  // {{{ function_name }}} 
  // IO correctness
  TEST_F({{{ function_name }}}, HandlesCorrectInput) {
    // Setup 
    // Load or prepare any necessary data for testing
    ...Prepare data here...
    
    // Test that {{{ TestFixtureClassName }}}(x) returns y.
  ...
  // tested.
  TEST_F({{{ function_name }}}, HandlesEdgeCase) {
    // Setup 
    // Load or prepare any necessary data for testing
    ...Prepare data here...
  ...
  TEST_F({{{ function_name }}}, CaptureError) {
    // Setup 
    // Load or prepare any necessary data for testing
    ...Prepare data here...
