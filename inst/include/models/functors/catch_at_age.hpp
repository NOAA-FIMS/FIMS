...
namespace fims_popdy
{
    ...
    public:
         ...
         * 
         */
        std::map<uint32_t, std::map<std::string, fims::Vector<Type>>> fleet_derived_quantities;
        /**
         * @brief The derived quantities for all populations, indexed by
         * population id.
         * 
         */
        std::map<uint32_t, std::map<std::string, fims::Vector<Type>>> population_derived_quantities;
        /**
         * @brief Iterate through fleet-based derived quantities.
         * 
         */
        typedef typename std::map<uint32_t, std::map<std::string, fims::Vector<Type>>>::iterator fleet_derived_quantities_iterator;
        /**
         * @brief Iterate through population-based derived quantities.
         * 
         */
        typedef typename std::map<uint32_t, std::map<std::string, fims::Vector<Type>>>::iterator population_derived_quantities_iterator;
        /**
