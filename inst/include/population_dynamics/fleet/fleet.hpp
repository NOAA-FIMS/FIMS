...
struct Fleet : public fims_model_object::FIMSObject<Type> {
  ...
  fims::Vector<Type>
      length_composition; /*!<derived quantity length composition*/
  fims::Vector<Type>
      age_length_conversion_matrix; /*!<derived quantity age-length transition
                                       matrix*/
...
to log probability density function*/
  fims::Vector<Type> expected_index_lpdf;  /*!<model expected index of abundance
 linked  to log probability density function*/
  fims::Vector<Type> catch_numbers_at_age; /*!<model expected catch at age*/
  fims::Vector<Type>
      catch_numbers_at_length; /*!<model expected catch at length*/
  fims::Vector<Type>
      proportion_catch_numbers_at_age; /*!<model expected catch at age*/
  fims::Vector<Type>
      proportion_catch_numbers_at_length; /*!<model expected catch at length*/
  ...
  void Prepare() {
    ...
    std::fill(proportion_catch_numbers_at_age.begin(),
              proportion_catch_numbers_at_age.end(),
              0); /**<model expected catch at age*/
    std::fill(catch_numbers_at_length.begin(), catch_numbers_at_length.end(),
              0); /**<model expected catch at length*/
    std::fill(proportion_catch_numbers_at_length.begin(),
              proportion_catch_numbers_at_length.end(),
              0); /**<model expected catch at length*/
