...
/**
 * @brief DescendingLogisticSelectivity class that returns the Descending logistic
...
struct DescendingLogisticSelectivity : public SelectivityBase<Type> {
  ...
  /**
   * @brief Method of the Descending logistic selectivity class that implements the
   * Descending logistic function from FIMS math.
   *
   * \left(1.0-\frac{1.0}{ 1.0 + exp(-1.0 * slope\_desc (x -
   * inflection_point\_desc))} \right)\f$
   *
   * @param x  The independent variable in the descending logistic function (e.g.,
