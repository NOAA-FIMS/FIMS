  ...
  struct DoubleLogisticSelectivity : public SelectivityBase<Type>
  {
    ...
    virtual const Type evaluate(const Type &x)
    {
      return fims_math::double_logistic<Type>(
          inflection_point_asc[0], fims_math::exp<Type>(slope_asc[0]),
          inflection_point_desc[0], fims_math::exp<Type>(slope_desc[0]), x);
    }
    ...
    virtual const Type evaluate(const Type &x, size_t pos)
    {
      return fims_math::double_logistic<Type>(
          ...
          fims_math::exp<Type>(slope_asc.get_force_scalar(pos)),
          inflection_point_desc.get_force_scalar(pos),
          fims_math::exp<Type>(slope_desc.get_force_scalar(pos)), x);
    }
  };
