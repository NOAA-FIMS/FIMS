...
namespace fims {
    ...
    struct Population : public FIMSObject<Type> {
        ...
        void Evaluate() {
            ...
            REPORT_F(fims::ModelTraits<Type>::MakeVariableVector(this->numbers_at_age), of);
            REPORT_F(fims::ModelTraits<Type>::MakeVariableVector(this->recruitment->recruit_deviations), of);
...
//            ADREPORT_F(fims::ModelTraits<Type>::MakeVariableVector(this->M), of);
