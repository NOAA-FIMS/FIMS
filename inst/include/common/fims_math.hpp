...
inline const Type logistic(const Type &inflection_point, const Type &slope,
                           const Type &x) {
  return static_cast<Type>(1.0) / (static_cast<Type>(1.0) + exp(Type(-1.0) * slope * (x - inflection_point)));
}
...
inline const Type double_logistic(const Type &inflection_point_asc,
  ...
  return (static_cast<Type>(1.0)) / (static_cast<Type>(1.0) + exp(Type(-1.0) * slope_asc * (x - inflection_point_asc))) *
         (static_cast<Type>(1.0) -
          (static_cast<Type>(1.0)) / (static_cast<Type>(1.0) + exp(Type(-1.0) * slope_desc * (x - inflection_point_desc))));
}
