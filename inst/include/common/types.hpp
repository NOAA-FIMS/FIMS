/**
 * @file types.hpp
 * @brief Centralized definition of core model types, enumerations, and
 * structures.
 * @details This file serves as a lightweight, dependency-free foundation for
 * the fims namespace.
...
struct Transformation {
   ...
   * - `exp`: Exponential transformation, parameter is on the multiplicative
   * scale.
   ...
   * - `sqrt`: Square root transformation, parameter is on the square root
   * scale.
   */
  enum class Label { identity, exp, log, logit, square, sqrt };
  /**
...
struct Distribution {
   ...
   */
  enum class Label { Normal, Lognormal, Gamma, InvGamma };
