...
namespace fims_info
{
  ...
  public:
    ...
    std::string State()
    {
      ...
      ss << "fixed_effects_parameters: " << this->fixed_effects_parameters.size() << std::endl;
      ...
      ss << "random_effects_names: " << this->random_effects_names.size() << std::endl;
      ss << "random_effects_parameters: " << this->random_effects_parameters.size() << std::endl;
      ss << "recruitment_models: " << this->recruitment_models.size() << std::endl;
      ss << "recruitment_process_models: " << this->recruitment_process_models.size() << std::endl;
      ss << "selectivity_models: " << this->selectivity_models.size() << std::endl;
      ...
      ss << "density_components: " << this->density_components.size() << std::endl;
      return ss.str();
    }
