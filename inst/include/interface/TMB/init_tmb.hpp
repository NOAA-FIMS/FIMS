...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"fims_call_logistic_maturity", (DL_FUNC)&fims_call_logistic_maturity, 2},
    {"fims_call_create_ewaa_growth", (DL_FUNC)&fims_call_create_ewaa_growth, 4},
    {"fims_call_ewaa_growth_evaluate", (DL_FUNC)&fims_call_ewaa_growth_evaluate,
     3},
    {"fims_call_create_fleet", (DL_FUNC)&fims_call_create_fleet, 6},
    {"fims_call_fleet_prepare", (DL_FUNC)&fims_call_fleet_prepare, 1},
    {"fims_call_create_population", (DL_FUNC)&fims_call_create_population, 10},
    {"fims_call_population_prepare", (DL_FUNC)&fims_call_population_prepare, 1},
    {"fims_call_create_model", (DL_FUNC)&fims_call_create_model, 0},
    {"fims_call_build_default_likelihood",
     (DL_FUNC)&fims_call_build_default_likelihood, 17},
    ...
    {"fims_call_information_clear", (DL_FUNC)&fims_call_information_clear, 0},
    ...
    {"fims_call_information_get_random_effect_names",
     (DL_FUNC)&fims_call_information_get_random_effect_names, 0},
    TMB_CALLDEFS,
    {NULL, NULL, 0}};
