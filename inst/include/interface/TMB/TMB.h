...
// Redefine
/**
 * @brief Define WITH_LIBTMB to indicate that the TMB library is being used in
 * user code. This can be used to conditionally compile code that depends on the
 * TMB library.
 */
#define WITH_LIBTMB
#undef TMB_PRECOMPILE
