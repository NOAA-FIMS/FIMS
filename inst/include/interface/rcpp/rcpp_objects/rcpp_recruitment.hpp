...
public:
  ...
  {
    fims::Vector<double> logit_steep_uncertainty(this->logit_steep.size(), -99999999);
    this->get_se_values("logit_steep", se_values, logit_steep_uncertainty);
    fims::Vector<double> log_rzero_uncertainty(this->log_rzero.size(), -999999999);
    this->get_se_values("log_rzero", se_values, log_rzero_uncertainty);
    fims::Vector<double> log_devs_uncertainty(this->log_devs.size(), -999999999);
