...
public:
    ...
    // The Global GPS (variable_map): This is vital because it allows the DSEM mathematical "engine" to find these numbers no matter which module they live in (Recruitment, Growth, etc.) to build a master map of the whole system
    bool add_to_fims_tmb_internal() {
        std::shared_ptr<fims_info::Information<Type>> info = 
            fims_info::Information<Type>::GetInstance();
        ...
        register_beta_z_standardized<Type>(this, recruitment, info, "beta_z_rec");
