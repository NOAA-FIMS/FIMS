...
class BevertonHoltRecruitmentInterface : public RecruitmentInterfaceBase {
 public:
  ...
  std::shared_ptr<BevertonHoltRecruitmentInterface> deep_copy() const {
    ...
    copy->logit_steep = DeepCopyParameterVector(this->logit_steep);
    copy->log_rzero = DeepCopyParameterVector(this->log_rzero);
    copy->log_devs = DeepCopyParameterVector(this->log_devs);
    copy->log_r = DeepCopyParameterVector(this->log_r);
    copy->log_expected_recruitment =
        DeepCopyParameterVector(this->log_expected_recruitment);
