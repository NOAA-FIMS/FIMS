...
public:
    ...
    nyears(other.nyears), maturity_id(other.maturity_id), 
    growth_id(other.growth_id), recruitment_id(other.recruitment_id), 
    log_M(other.log_M), log_init_naa(other.log_init_naa), ages(other.ages), 
    proportion_female(other.proportion_female), estimate_M(other.estimate_M), 
    estimate_initNAA(other.estimate_initNAA), 
    estimate_prop_female(other.estimate_prop_female) {
    }
