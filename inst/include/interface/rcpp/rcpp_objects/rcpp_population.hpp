...
class PopulationInterface : public PopulationInterfaceBase {
 public:
  ...
  uint32_t linked_population_id; /**< id of a population that affects this one */
  ...
  void SetLinkedPopulations(uint32_t population_id){
    this->linked_population_id = population_id;
  }
  ...
  bool add_to_fims_tmb_internal() {
    ...
    population->linked_population_id = this->linked_population_id;
