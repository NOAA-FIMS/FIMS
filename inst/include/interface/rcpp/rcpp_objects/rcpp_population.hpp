...
class PopulationInterface : public PopulationInterfaceBase {
 public:
  ...
  std::shared_ptr<PopulationInterface> deep_copy() const {
    ...
    copy->log_M = DeepCopyVariableVector(this->log_M);
    copy->spawning_biomass_ratio =
        DeepCopyVariableVector(this->spawning_biomass_ratio);
    copy->log_f_multiplier = DeepCopyVariableVector(this->log_f_multiplier);
    copy->log_init_naa = DeepCopyVariableVector(this->log_init_naa);
