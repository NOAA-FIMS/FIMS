...
public:
  ...
  add_to_fims_tmb ()
  {
    ...
    std::shared_ptr<fims::DataObject<TMB_FIMS_FIRST_ORDER> > age_comp_data_1
        = std::make_shared<fims::DataObject<TMB_FIMS_FIRST_ORDER> > (
            this->ymax, this->amax);
    std::shared_ptr<fims::DataObject<TMB_FIMS_SECOND_ORDER> > age_comp_data_2
        = std::make_shared<fims::DataObject<TMB_FIMS_SECOND_ORDER> > (
            this->ymax, this->amax);
    std::shared_ptr<fims::DataObject<TMB_FIMS_THIRD_ORDER> > age_comp_data_3
        = std::make_shared<fims::DataObject<TMB_FIMS_THIRD_ORDER> > (
            this->ymax, this->amax);
