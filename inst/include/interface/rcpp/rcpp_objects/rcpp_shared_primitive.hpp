...
class SharedInt {
 ...
 public:
   ...
   * @return int
   */
  int operator*() const { return *value; }  // Dereference
   ...
   * @return int*
   */
  int* operator->() { return value.get(); }  // Arrow operator
   ...
   * @return const int*
   */
  const int* operator->() const { return value.get(); }  // Const arrow operator
...
class SharedString {
 ...
 public:
   ...
   * @return std::string
   */
  std::string operator*() const { return *value; }  // Dereference
   ...
   * @return std::string*
   */
  std::string* operator->() { return value.get(); }  // Arrow operator
...
class SharedBoolean {
 ...
 public:
   ...
   * @return false
   */
  bool operator*() const { return *value; }  // Dereference
   ...
   * @return false
   */
  bool* operator->() { return value.get(); }  // Arrow operator
