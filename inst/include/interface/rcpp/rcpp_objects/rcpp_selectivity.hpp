 ...
 public:
  ...
  std::shared_ptr<DoubleLogisticSelectivityInterface> deep_copy() const {
    ...
    copy->inflection_point_asc =
        DeepCopyVariableVector(this->inflection_point_asc);
    copy->slope_asc = DeepCopyVariableVector(this->slope_asc);
    copy->inflection_point_desc =
        DeepCopyVariableVector(this->inflection_point_desc);
    copy->slope_desc = DeepCopyVariableVector(this->slope_desc);
