...
public:
   ...
   *   @param x  The independent variable in the logistic function (e.g., age
   * or size in selectivity).
   */
  virtual double
  evaluate (double x)
  {
  ...
  add_to_fims_tmb ()
  {
    ...
    std::shared_ptr<fims::LogisticSelectivity<TMB_FIMS_FIRST_ORDER> > ls1
        = std::make_shared<
            fims::LogisticSelectivity<TMB_FIMS_FIRST_ORDER> > ();
    ...
    std::shared_ptr<fims::LogisticSelectivity<TMB_FIMS_SECOND_ORDER> > ls2
        = std::make_shared<
            fims::LogisticSelectivity<TMB_FIMS_SECOND_ORDER> > ();
    ...
    std::shared_ptr<fims::LogisticSelectivity<TMB_FIMS_THIRD_ORDER> > ls3
        = std::make_shared<
            fims::LogisticSelectivity<TMB_FIMS_THIRD_ORDER> > ();
...
public:
  Parameter
      median_asc;      /**< the index value at which the response reaches .5 */
