...
public:
    ...
    interface_agecomp_likelihood_id_m(other.interface_agecomp_likelihood_id_m),
    interface_index_likelihood_id_m(other.interface_index_likelihood_id_m),
    ...
    is_survey(other.is_survey), nages(other.nages),
    nyears(other.nyears), log_q(other.log_q),
    log_Fmort(other.log_Fmort), estimate_F(other.estimate_F),
    estimate_q(other.estimate_q), estimate_obs_error(other.estimate_obs_error),
    random_q(other.random_q), random_F(other.random_F),
    log_obs_error(other.log_obs_error) {
    }
