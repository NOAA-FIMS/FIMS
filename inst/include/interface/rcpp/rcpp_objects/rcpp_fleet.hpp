...
public:
   ...
   * @param other
   */
  FleetInterface(const FleetInterface &other) : FleetInterfaceBase(other),
  ...
  {
    FleetInterface copy;
    copy.interface_observed_agecomp_data_id_m.set(this->interface_observed_agecomp_data_id_m.get());
    copy.interface_observed_lengthcomp_data_id_m.set(this->interface_observed_lengthcomp_data_id_m.get());
    copy.interface_observed_index_data_id_m.set(this->interface_observed_index_data_id_m.get());
    copy.interface_observed_landings_data_id_m.set(this->interface_observed_landings_data_id_m.get());
    copy.interface_selectivity_id_m.set(this->interface_selectivity_id_m.get());
    copy.name = this->name;
    copy.nages.set(this->nages.get());
    copy.nlengths.set(this->nlengths.get());
    copy.nyears.set(this->nyears.get());
    copy.log_q = this->log_q.Copy();
    copy.log_Fmort = this->log_Fmort.Copy();
    copy.log_index_expected = this->log_index_expected.Copy();
    copy.log_landings_expected = this->log_landings_expected.Copy();
    copy.agecomp_proportion = this->agecomp_proportion.Copy();
    copy.lengthcomp_proportion = this->lengthcomp_proportion.Copy();
