...
template <typename Scalar> struct functor_traits<scalar_opposite_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_abs_op<Scalar>> {
  enum {
    Cost = NumTraits<Scalar>::AddCost,
...
template <typename Scalar> struct functor_traits<scalar_abs2_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_conjugate_op<Scalar>> {
  enum {
    Cost = 0,
...
template <typename Scalar> struct functor_traits<scalar_arg_op<Scalar>> {
  enum {
 ...
 */
template <typename Scalar, int N> struct scalar_shift_right_op {
 ...
 */
template <typename Scalar, int N> struct scalar_shift_left_op {
...
template <typename Scalar> struct functor_traits<scalar_real_op<Scalar>> {
...
template <typename Scalar> struct functor_traits<scalar_imag_op<Scalar>> {
  enum { Cost = 0, PacketAccess = false };
};
 ...
 * \sa class CwiseUnaryOp, MatrixBase::real()
 */
template <typename Scalar> struct scalar_real_ref_op {
...
template <typename Scalar> struct functor_traits<scalar_real_ref_op<Scalar>> {
  enum { Cost = 0, PacketAccess = false };
};
 ...
 * \sa class CwiseUnaryOp, MatrixBase::imag()
 */
template <typename Scalar> struct scalar_imag_ref_op {
...
template <typename Scalar> struct functor_traits<scalar_imag_ref_op<Scalar>> {
  enum { Cost = 0, PacketAccess = false };
};
...
template <typename Scalar> struct functor_traits<scalar_exp_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_expm1_op<Scalar>> {
  enum {
    PacketAccess = packet_traits<Scalar>::HasExpm1,
    Cost = functor_traits<scalar_exp_op<Scalar>>::Cost // TODO measure cost of
                                                       // expm1
  };
};
...
template <typename Scalar> struct functor_traits<scalar_log_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_log1p_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_log10_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_log2_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
    PacketAccess = packet_traits<Scalar>::HasLog
  };
...
template <typename Scalar> struct functor_traits<scalar_sqrt_op<Scalar>> {
  enum {
#if EIGEN_FAST_MATH
    // The following numbers are based on the AVX implementation.
...
// Boolean specialization to eliminate
// -Wimplicit-conversion-floating-point-to-bool warnings.
template <> struct scalar_sqrt_op<bool> {
  EIGEN_EMPTY_STRUCT_CTOR(scalar_sqrt_op)
  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC inline bool
  operator()(const bool &a) const {
    return a;
  }
  template <typename Packet>
  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC inline Packet
  packetOp(const Packet &a) const {
    return a;
  }
};
template <> struct functor_traits<scalar_sqrt_op<bool>> {
...
template <typename Scalar> struct functor_traits<scalar_rsqrt_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_cos_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_sin_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_tan_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_acos_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_asin_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_atan_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
 ...
 */
template <typename Scalar> struct scalar_atanh_op {
...
template <typename Scalar> struct functor_traits<scalar_atanh_op<Scalar>> {
...
template <typename Scalar> struct functor_traits<scalar_sinh_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
 ...
 */
template <typename Scalar> struct scalar_asinh_op {
...
template <typename Scalar> struct functor_traits<scalar_asinh_op<Scalar>> {
  enum { Cost = 5 * NumTraits<Scalar>::MulCost, PacketAccess = false };
};
#endif
...
template <typename Scalar> struct functor_traits<scalar_cosh_op<Scalar>> {
  enum {
    Cost = 5 * NumTraits<Scalar>::MulCost,
 ...
 */
template <typename Scalar> struct scalar_acosh_op {
...
template <typename Scalar> struct functor_traits<scalar_acosh_op<Scalar>> {
  enum { Cost = 5 * NumTraits<Scalar>::MulCost, PacketAccess = false };
};
#endif
...
template <typename Scalar> struct functor_traits<scalar_inverse_op<Scalar>> {
  enum {
...
template <typename Scalar> struct functor_traits<scalar_square_op<Scalar>> {
  enum {
    Cost = NumTraits<Scalar>::MulCost,
...
template <> struct scalar_square_op<bool> {
  EIGEN_EMPTY_STRUCT_CTOR(scalar_square_op)
  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC inline bool
  operator()(const bool &a) const {
    return a;
  ...
  template <typename Packet>
  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC inline const Packet
  packetOp(const Packet &a) const {
    return a;
  }
};
template <> struct functor_traits<scalar_square_op<bool>> {
...
template <typename Scalar> struct functor_traits<scalar_cube_op<Scalar>> {
  enum {
...
// Boolean specialization to avoid -Wint-in-bool-context warnings on GCC.
template <> struct scalar_cube_op<bool> {
  EIGEN_EMPTY_STRUCT_CTOR(scalar_cube_op)
  EIGEN_DEPRECATED EIGEN_DEVICE_FUNC inline bool
  operator()(const bool &a) const {
    return a;
...
template <> struct functor_traits<scalar_cube_op<bool>> {
  enum { Cost = 0, PacketAccess = packet_traits<bool>::Vectorizable };
};
...
template <typename Scalar> struct functor_traits<scalar_round_op<Scalar>> {
  enum {
    Cost = NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_floor_op<Scalar>> {
  enum {
    Cost = NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_rint_op<Scalar>> {
  enum {
    Cost = NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_ceil_op<Scalar>> {
  enum {
    Cost = NumTraits<Scalar>::MulCost,
...
template <typename Scalar> struct functor_traits<scalar_isnan_op<Scalar>> {
...
template <typename Scalar> struct functor_traits<scalar_isinf_op<Scalar>> {
  enum { Cost = NumTraits<Scalar>::MulCost, PacketAccess = false };
};
...
template <typename Scalar> struct functor_traits<scalar_isfinite_op<Scalar>> {
  enum { Cost = NumTraits<Scalar>::MulCost, PacketAccess = false };
};
...
template <typename Scalar> struct scalar_sign_op<Scalar, false, true> {
...
template <typename Scalar> struct scalar_sign_op<Scalar, false, false> {
  EIGEN_EMPTY_STRUCT_CTOR(scalar_sign_op)
  EIGEN_DEVICE_FUNC inline const Scalar operator()(const Scalar &a) const {
...
template <typename Scalar> struct functor_traits<scalar_sign_op<Scalar>> {
  enum {
 ...
 *
 */
template <> struct scalar_logistic_op<float> {
  EIGEN_EMPTY_STRUCT_CTOR(scalar_logistic_op)
  ...
  packetOp(const Packet &_x) const {
    ...
    // The upper cut-off is the smallest x for which the rational approximation
    // evaluates to 1. Choosing this value saves us a few instructions clamping
...
template <typename T> struct functor_traits<scalar_logistic_op<T>> {
  enum {
