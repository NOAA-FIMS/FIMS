...
struct traits<ReturnByValue<Derived>>
  ...
  enum {
    ...
    // the Block-with-DirectAccess expression requires to have a coeffRef
    // method.
 ...
 * matrix type.
 *
 * FIXME: I don't understand why we need this specialization: isn't this taken
 * care of by the EvalBeforeNestingBit ?? Answer: EvalBeforeNestingBit should be
 * deprecated since we have the evaluators
 */
...
// Expression is evaluated in a temporary; default implementation of Assignment
// is bypassed so that when a ReturnByValue expression is assigned, the
// evaluator is not constructed.
// TODO: Finalize port to new regime; ReturnByValue should not exist in the
// expression world
