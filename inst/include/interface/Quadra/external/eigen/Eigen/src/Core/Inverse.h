...
public:
  ...
  typedef
      typename internal::remove_all<XprTypeNested>::type XprTypeNestedCleaned;
 ...
 * into a temporary by a call to internal::call_assignment_no_alias. Therefore,
 * inverse implementers only have to specialize Assignment<Dst,Inverse<...>,
 * ...> for there own nested expression.
 *
 * \sa class Inverse
 */
