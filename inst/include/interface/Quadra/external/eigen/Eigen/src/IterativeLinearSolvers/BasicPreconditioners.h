...
/** \ingroup IterativeLinearSolvers_Module
  ...
  * This class allows to approximately solve for A.x = b problems assuming A is
  a diagonal matrix.
  * In other words, this preconditioner neglects all off diagonal entries and,
  in Eigen's language, solves for: \code A.diagonal().asDiagonal() . x = b
    \endcode
  *
  ...
  *
  * \note A variant that has yet to be implemented would attempt to preserve the
  norm of each column.
  *
...
public:
  ...
  solve(const MatrixBase<Rhs> &b) const {
    ...
    eigen_assert(m_invdiag.size() == b.rows() &&
                 "DiagonalPreconditioner::solve(): invalid number of rows of "
...
/** \ingroup IterativeLinearSolvers_Module
  ...
  * In other words, this preconditioner neglects all off diagonal entries and,
  in Eigen's language, solves for: \code (A.adjoint() *
  A).diagonal().asDiagonal() * x = b \endcode
  *
  * \tparam _Scalar the type of the scalar.
  *
  * \implsparsesolverconcept
