 ...
 * expression.
 *
 * \warning To be used with care because an evaluator is constructed every time
 * an InnerIterator iterator is constructed.
 *
 * TODO: add a usage example
 */
template <typename XprType> class InnerIterator {
protected:
  typedef internal::inner_iterator_selector<
      XprType, typename internal::evaluator_traits<XprType>::Kind>
      IteratorType;
...
public:
  ...
  /// \returns \c true if the iterator \c *this still references a valid
  /// coefficient.
...
template <typename XprType> class inner_iterator_selector<XprType, IndexBased> {
protected:
