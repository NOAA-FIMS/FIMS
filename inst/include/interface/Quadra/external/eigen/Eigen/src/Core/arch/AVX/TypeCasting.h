...
// For now we use SSE to handle integers, so we can't use AVX instructions to
...
preinterpret<Packet8i, Packet8f>(const Packet8f &a) {
  return _mm256_castps_si256(a);
}

template <>
EIGEN_STRONG_INLINE Packet8f
preinterpret<Packet8f, Packet8i>(const Packet8i &a) {
