 ...
 * More precisely it alloas to bypass the EvalBeforeAssignBit flag of the source
 * expression. It is the return type of MatrixBase::noalias() and most of the
 ...
 * Therefore, there is no alternative than evaluating A * B in a temporary, that
 * is the default behavior when you write: \code A = A * B; \endcode
 *
 * \sa class NoAlias
 */
