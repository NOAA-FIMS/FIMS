...
/// either run-time or compile-time, or AutoSize \param nCols the number of
/// columns in the reshaped expression, specified at either run-time or
/// compile-time, or AutoSize \tparam Order specifies whether the coefficients
/// should be processed in column-major-order (ColMajor), in row-major-order
/// (RowMajor),
...
/// typically Index. \tparam NColsType the type of the value handling the number
/// of columns, typically Index.
///
...
/// columns: \include MatrixBase_reshaped_fixed.cpp Output: \verbinclude
/// MatrixBase_reshaped_fixed.out
///
/// Finally, one of the sizes parameter can be automatically deduced from the
/// other one by passing AutoSize as in the following example: \include
/// MatrixBase_reshaped_auto.cpp Output: \verbinclude
/// MatrixBase_reshaped_auto.out AutoSize does preserve compile-time sizes when
/// possible, i.e., when the sizes of the input are known at compile time \b and
