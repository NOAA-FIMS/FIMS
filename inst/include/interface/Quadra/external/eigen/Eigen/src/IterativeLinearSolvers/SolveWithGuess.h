...
class SolveWithGuess
    : public internal::generic_xpr_base<
          SolveWithGuess<Decomposition, RhsType, GuessType>, MatrixXpr,
...
public:
  ...
  SolveWithGuess(const Decomposition &dec, const RhsType &rhs,
...
struct evaluator<SolveWithGuess<Decomposition, RhsType, GuessType>>
    : public evaluator<typename SolveWithGuess<Decomposition, RhsType,
                                               GuessType>::PlainObject> {
...
template <typename DstXprType, typename DecType, typename RhsType,
          typename GuessType, typename Scalar>
struct Assignment<DstXprType, SolveWithGuess<DecType, RhsType, GuessType>,
