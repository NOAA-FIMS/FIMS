...
struct NormalLPDF : public DensityComponentBase<Type> {
    ...
    virtual const Type evaluate(){
      ...
      if( n_x != this->expected_values.size()){
        throw std::invalid_argument("NormalLPDF::Vector index out of bounds. The size of observed data does not equal the size of expected values. The observed data vector is of size " + 
      ...
      if( this->log_sd.size() > 1 & n_x != this->log_sd.size()){
        throw std::invalid_argument("NormalLPDF::Vector index out of bounds. The size of observed data does not equal the size of the log_sd vector. The observed data vector is of size " + 
