...
setwd("/Users/matthew.supernaw/FIMS-Testing/dev-json-caa/9_12/9_15/9_16/9_17/FIMS")
# The following code loads
# "age_data" "index_data" "landings_data"
# "length_age_data" "length_comp_data" "weightatage_data"
load(test_path("fixtures", "integration_test_data_components.RData"))
# "em_input_list" "om_input_list" "om_output_list"
...
em_input[["L.obs"]][["fleet1"]]
report$landings_expected[[1]]

log(om_output[["L.mt"]][["fleet1"]])
report$log_landings_expected[[1]]


landings_nll_fleet_2 <- -sum(dlnorm(
  report$landings_expected[[1]],
  report$log_landings_expected[[1]],
  sqrt(log(em_input[["cv.L"]][["fleet1"]]^2 + 1)), TRUE
))

landings_nll_fleet_3 <- report[["nll_components"]][2]

report[["nll_components"]]
landings_nll_fleet
landings_nll_fleet_2
landings_nll_fleet_3
